...
class _TeamScreenState extends State<TeamScreen> {
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Icon(Iconsax.add, size: 18, color: AppColors.primary),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (teamProvider.teamMembers.isEmpty)
                            ...
                            ...teamProvider.teamMembers.map((member) =>
  ...
  Widget _buildMemberCard(UserModel member, DashboardProvider dashboardProvider) {
    ...
    final durationSec = stats?['duration'] as int? ?? 0;
